...
/**
 * TAsPage component
 * Allows instructors to view, search, sort, and inspect details of all available TAs.
 */
...
const TAsPage = () => {
  ...
  /**
   * Navigates to TA profile view and sets the selected TA ID.
   */
  ...
  /**
 * Resets the view to show the TA list instead of profile.
 */
  ...
  /**
   * Fetches all TA profiles from the server on initial load.
   */
  ...
  /**
   * Creates a single TA item card component with selection support.
   */
  ...
  /**
   * Updates the selected TA in state when clicked.
   */
  ...
  /**
 * Filters and sorts TAs based on user search input and selected sort criteria.
 */
  useEffect(() => {
