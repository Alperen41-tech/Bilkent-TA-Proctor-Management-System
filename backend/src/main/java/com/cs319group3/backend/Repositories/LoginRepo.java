...
public interface LoginRepo extends JpaRepository<Login, Integer> {
    ...
    @Query("SELECT l FROM Login l WHERE l.userId = (SELECT u.userId FROM User u WHERE u.email = :email)")
    Optional<Login> findCustom(@Param("email") String email, @Param("password") String password);
}
